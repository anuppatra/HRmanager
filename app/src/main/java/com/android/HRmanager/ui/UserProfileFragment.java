...
import com.android.HRmanager.data.GroupDB;
import com.android.HRmanager.data.SharedPreferenceHelper;
import com.android.HRmanager.data.StaticConfig;
import com.android.HRmanager.model.Configuration;
import com.android.HRmanager.model.User;
import com.android.HRmanager.service.ServiceUtils;
import com.android.HRmanager.util.ImageUtils;
...
public class UserProfileFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        applications=(Button)view.findViewById(R.id.application);
        applications.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent myIntent = new Intent(UserProfileFragment.this.getActivity(),application_section.class);
